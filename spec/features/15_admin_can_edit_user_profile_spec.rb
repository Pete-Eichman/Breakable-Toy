...
feature "Admin can edit another user's profile" do
  ...
  context "As an Admin on another User's edit page" do
    scenario "Admin successfully update account details on the edit page" do
      visit user_path(users[1])
      click_link("Edit Account")
    ...
    scenario "Admin a password that's too short" do
      visit user_path(users[1])
      click_link("Edit Account")
      fill_in("Email", with: "testemail01@gmail.com")
    ...
    scenario "Admin enters an incorrect current password" do
      visit user_path(users[1])
      click_link("Edit Account")
      fill_in("Email", with: "testemail01@gmail.com")
      fill_in("Password", with: "pass02")
    ...
    scenario "Admin enters mismatching passwords" do
      visit user_path(users[1])
      click_link "Edit Account"
      fill_in("Email", with: "testemail01@gmail.com")
    ...
    scenario "Admin enters an invalid email address" do
      visit user_path(users[1])
      click_link "Edit Account"
